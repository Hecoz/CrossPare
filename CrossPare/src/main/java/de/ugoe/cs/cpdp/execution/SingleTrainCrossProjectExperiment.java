 ...
 */
public class SingleTrainCrossProjectExperiment extends SingleTrainAbstractCrossProjectExperiment {
    ...
    public SingleTrainCrossProjectExperiment(ExperimentConfiguration config) {
        super(config);
    }
