 ...
 */
public class SclModelCrossProjectExperiment extends SclModelAbstractCrossProjectExperiment {
    ...
    public SclModelCrossProjectExperiment(ExperimentConfiguration config) {
        super(config);
    }
